...
# error "NEON::common: Configuration option CONFIG_DEBUG is out of range."
#endif

#if ((CONFIG_API_VALIDATION != 1) && (CONFIG_API_VALIDATION != 0))
# error "NEON::common: Configuration option CONFIG_DEBUG_API_VALIDATION is out of range."
#endif

#if ((CONFIG_ASSERT_INTERNAL != 1) && (CONFIG_ASSERT_INTERNAL != 0))
# error "NEON::common: Configuration option CONFIG_DEBUG_INTERNAL_CHECK is out of range."
#endif
