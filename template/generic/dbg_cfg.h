 ...
 * @brief       Default Debug Configuration settings
...
# error "eSolid: Configuration option CFG_DBG_ENABLE is out of range."
#endif

#if ((1U != CFG_DBG_API_VALIDATION) && (0U != CFG_DBG_API_VALIDATION))
# error "eSolid: Configuration option CFG_DBG_API_VALIDATION is out of range."
#endif

#if ((1U != CFG_DBG_INTERNAL_CHECK) && (0U != CFG_DBG_INTERNAL_CHECK))
# error "eSolid: Configuration option CFG_DBG_INTERNAL_CHECK is out of range."
#endif
