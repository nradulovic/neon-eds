    ...
    struct ncore_lock *          lock)
{
    ...
    ipl_status  = _CP0_GET_STATUS();
    ipl_status &= ~_CP0_STATUS_IPL_MASK;
    ipl_status |= lock->level & _CP0_STATUS_IPL_MASK;
    _CP0_SET_STATUS(ipl_status);
#else
